"""
data structures part 2: the list part was already submited
...
list_of_country1=['tel-aviv','jerusalem']
list_of_country2=['cairo','luxor']
list_of_country3=['rome','genua']
list_of_country4=['munich','berlin']

dictionary_continent1={country1:list_of_country1
                 ,country2:list_of_country2}

dictionary_continent2={country3:list_of_country3
                 ,country4:list_of_country4}

world_dict={continent1:dictionary_continent1
            ,continent2:dictionary_continent2}
